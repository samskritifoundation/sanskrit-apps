...
export default {
  ...
  mounted() {
    // console.log(this.id)
    this.lesson = this.$store.state.samasashikhamani_lessons.find(
  ...
  created() {
    ...
    this.index = this.$store.state.samasashikhamani_lessons.findIndex(
      lesson => String(lesson.id) === this.id
    )
    this.prev_lesson = this.$store.state.samasashikhamani_lessons[
      this.index - 1
    ]
    this.next_lesson = this.$store.state.samasashikhamani_lessons[
      this.index + 1
    ]
    this.length = this.$store.state.samasashikhamani_lessons.length
    this.previous =
      this.index > 1
        ? '/samasashikhamani/lessons/' + this.prev_lesson.id
        : '/samasashikhamani/lessons/1'
    this.next =
      this.index < this.length - 1
        ? '/samasashikhamani/lessons/' + this.next_lesson.id
        : '/samasashikhamani/lessons/'
