  ...
  <v-layout
    ...
    <v-flex
      ...
      <v-card
        ...
        dark>
        <h1>समासचक्रवर्ती-शिक्षकः - परस्परव्यवहारपूर्वकशिक्षणम्</h1>
        <h1>Interactive tutorial for Samāsacakravartī</h1>
        <v-card-text>
          ...
          <v-card-actions>
            <v-dialog
              ...
              <v-btn
                ...
                large> About <br> Samāsacakravartī</v-btn>
              <v-card
                color="info"
                class="papyrus bg1"
                light>
                <v-card-title><h1>Samāsacakravartī</h1></v-card-title>
                <v-divider/>
